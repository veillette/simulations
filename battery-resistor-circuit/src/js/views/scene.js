...
import TurnstileView from 'views/turnstile';
import AmmeterView from 'views/ammeter';
import ResistorView from 'views/resistor';
import WirePatchView from 'views/wire-patch';
import BatteryView from 'views/battery';
import ElectronView from 'views/electron';
import SpectrumView from 'views/spectrum';
import VoltageCalculationView from 'views/voltage-calculation';
