...
import VectorBinView from 'views/vector-bin';
import TrashCanView from 'views/trash-can';
import SumVectorView from 'views/sum-vector';
...
export default VectorAdditionSceneView;
