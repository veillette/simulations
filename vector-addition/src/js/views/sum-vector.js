...
import SumVectorXView from 'views/sum-vector-x';
import SumVectorYView from 'views/sum-vector-y';
import SumComponentsView from 'views/sum-components';
import SumVectorViewModel from 'models/sum-vector';
