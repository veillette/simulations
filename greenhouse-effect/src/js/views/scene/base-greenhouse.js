...
import InfraredFilter from 'models/filter/infrared';
import PhotonView from 'views/photon-basic';
import GreenhouseThermometerView from 'views/thermometer';
...
export default BaseGreenhouseSceneView;
