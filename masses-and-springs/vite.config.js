...
export default defineConfig({
    ...
    resolve: {
        ...
        alias: [
            ...
            { find: /^initials$/, replacement: path.resolve(jsDir, 'initials.js') },
            { find: 'collections', replacement: path.resolve(jsDir, 'collections') },
            { find: /^underscoreDeepExtend$/, replacement: path.resolve(__dirname, 'node_modules/underscore-deep-extend/index.js') },
