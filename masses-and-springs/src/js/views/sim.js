...
import RulerView from 'common/v3/tools/ruler';
import ReferenceLineView from 'common/v3/tools/reference-line';
import HelpLabelView from 'common/v3/help-label/index';
import BarGraphView from 'common/bar-graph/bar-graph';
import MassesAndSpringsSimulation from 'models/simulation';
import MassesAndSpringsSceneView from 'views/scene';
...
export default MassesAndSpringsSimView;
