...
export default defineConfig({
    ...
    resolve: {
        ...
        alias: [
            { find: 'beta-decay/templates', replacement: path.resolve(root, 'templates') },
            { find: 'beta-decay/styles',    replacement: path.resolve(root, 'styles') },
            { find: 'beta-decay',           replacement: jsDir },
