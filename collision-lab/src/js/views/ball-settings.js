...
import 'nouislider';
import template1DHtml from 'templates/ball-settings-1d-item.html?raw';
import template2DHtml from 'templates/ball-settings-2d-item.html?raw';
Backbone.$ = $;
...
export default BallSettingsView;
