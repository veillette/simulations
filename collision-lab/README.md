...
3. then go to [http://localhost:8080/collision-lab/test/](http://localhost:8080/collision-lab/test/). 
...
From the root `collision-lab` directory, run `npm run-script upgrade`, which executes the following commands:
