...
import BX_INTERNAL_CSV      from 'models/bfield/BX_internal.csv?raw';
import BY_INTERNAL_CSV      from 'models/bfield/BY_internal.csv?raw';
import BX_EXTERNAL_NEAR_CSV from 'models/bfield/BX_external_near.csv?raw';
import BY_EXTERNAL_NEAR_CSV from 'models/bfield/BY_external_near.csv?raw';
import BX_EXTERNAL_FAR_CSV  from 'models/bfield/BX_external_far.csv?raw';
import BY_EXTERNAL_FAR_CSV  from 'models/bfield/BY_external_far.csv?raw';
...
BarMagnet.BX_INTERNAL      = BX_INTERNAL_CSV;
BarMagnet.BY_INTERNAL      = BY_INTERNAL_CSV;
BarMagnet.BX_EXTERNAL_NEAR = BX_EXTERNAL_NEAR_CSV;
BarMagnet.BY_EXTERNAL_NEAR = BY_EXTERNAL_NEAR_CSV;
BarMagnet.BX_EXTERNAL_FAR  = BX_EXTERNAL_FAR_CSV;
BarMagnet.BY_EXTERNAL_FAR  = BY_EXTERNAL_FAR_CSV;
