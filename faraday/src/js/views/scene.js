...
import BFieldOutsideView from 'views/bfield/outside';
import BFieldInsideView from 'views/bfield/inside';
import FieldMeterView from 'views/field-meter';
import CompassView from 'views/compass';
import BarMagnetView from 'views/bar-magnet';
import PickupCoilView from 'views/pickup-coil';
...
export default FaradaySceneView;
