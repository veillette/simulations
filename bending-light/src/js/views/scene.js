...
import IntensityMeter from 'models/intensity-meter';
import LaserView from 'views/laser';
import LaserBeamsView from 'views/laser-beams';
import IntensityMeterView from 'views/intensity-meter';
import ProtractorView from 'views/protractor';
...
export default BendingLightSceneView;
