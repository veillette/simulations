...
export default defineConfig({
    ...
    resolve: {
        alias: [
            { find: 'nuclear-fission/templates', replacement: path.resolve(root, 'templates') },
            { find: 'nuclear-fission/styles',    replacement: path.resolve(root, 'styles') },
            { find: 'nuclear-fission',           replacement: jsDir },
