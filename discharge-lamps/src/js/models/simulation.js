...
import LasersSimulation from 'lasers/models/simulation';
import VanillaCollection from 'common/collections/vanilla';
import Vector2 from 'common/math/vector2';
import Tube from 'common/quantum/models/tube';
import ElectronSink from 'common/quantum/models/electron-sink';
import ElectronSource from 'common/quantum/models/electron-source';
import ElectronAtomCollisionExpert from 'common/quantum/models/electron-atom-collision-expert';
import Plate from 'common/quantum/models/plate';
import Spectrometer from './spectrometer';
import Battery from './battery';
import HeatingElement from './heating-element';
...
export default DischargeLampsSimulation;
