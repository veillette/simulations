...
import Functions from 'common/math/functions';
import PiecewiseCurve from 'common/math/piecewise-curve';
import RectangularThermalMovableElement from 'models/element/rectangular-thermal-movable';
import HorizontalSurface from 'models/horizontal-surface';
import ThermalContactArea from 'models/thermal-contact-area';
import EnergyChunk from 'models/energy-chunk';
import EnergyChunkDistributor from 'models/energy-chunk-distributor';
import EnergyChunkContainerSlice from 'models/energy-chunk-container-slice';
