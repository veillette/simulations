...
import ThermometerClipsView from 'views/thermometer-clips';
import BlockView from 'views/element/block';
import BrickView from 'views/element/brick';
import BeakerView from 'views/element/beaker';
import BurnerStandView from 'views/element/burner-stand';
import BurnerView from 'views/element/burner';
