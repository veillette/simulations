...
import SunView from 'views/body/sun';
import PlanetView from 'views/body/planet';
import MoonView from 'views/body/moon';
import SatelliteView from 'views/body/satellite';
import BodyTraceView from 'views/body-trace';
import CollisionView from 'views/collision';
