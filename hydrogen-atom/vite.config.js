...
const rutherfordDir = path.resolve(__dirname, '../rutherford-scattering');
...
export default defineConfig({
    ...
    resolve: {
        alias: [
            { find: 'hydrogen-atom/templates', replacement: path.resolve(root, 'templates') },
            { find: 'hydrogen-atom/styles',    replacement: path.resolve(root, 'styles') },
            { find: 'hydrogen-atom',           replacement: jsDir },
