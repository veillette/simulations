...
import HydrogenAtomSimulation from 'hydrogen-atom/models/simulation';
import AtomicModels from 'hydrogen-atom/models/atomic-models';
import HydrogenAtomSceneView from 'hydrogen-atom/views/scene';
import HydrogenAtomLegendView from 'hydrogen-atom/views/legend';
import HydrogenAtomWavelengthSliderView from 'hydrogen-atom/views/wavelength-slider';
import SpectrometerView from 'hydrogen-atom/views/spectrometer';
import SolarSystemEnergyDiagramView from 'hydrogen-atom/views/energy-diagram/solar-system';
import BohrEnergyDiagramView from 'hydrogen-atom/views/energy-diagram/bohr';
import DeBroglieEnergyDiagramView from 'hydrogen-atom/views/energy-diagram/debroglie';
import SchroedingerEnergyDiagramView from 'hydrogen-atom/views/energy-diagram/schroedinger';
import Constants from 'constants';
import Assets from 'assets';
import 'nouislider';
import 'hydrogen-atom/styles/sim.less';
import 'hydrogen-atom/styles/playback-controls.less';
import 'common/styles/slider.less';
import 'common/styles/radio.less';
import simHtml from 'hydrogen-atom/templates/sim.html?raw';
import playbackControlsHtml from 'hydrogen-atom/templates/playback-controls.html?raw';
...
export default HydrogenAtomSimView;
