import Matrix3D from 'common/math/matrix-3d';
import DeBroglieModelSubView from 'hydrogen-atom/views/atomic-model/debroglie-sub';
import Wireframe3DView from 'hydrogen-atom/views/wireframe-3d';
...
export default DeBroglieModel3DSubView;