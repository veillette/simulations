...
import underscoreDeepExtend from 'underscoreDeepExtend';
import SimView from 'common/app/sim';
import StopwatchView from 'common/tools/stopwatch';
import RulerView from 'common/tools/ruler';
import PendulumLabSimulation from 'models/simulation';
import PendulumLabSceneView from 'views/scene';
...
import optionsHtml from 'templates/select-options.html?raw';
import choiceListHtml from 'templates/choice-list.html?raw';
...
export default PendulumLabSimView;
