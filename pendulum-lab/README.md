...
3. then go to [http://localhost:8080/pendulum-lab/test/](http://localhost:8080/pendulum-lab/test/). 
...
From the root `pendulum-lab` directory, run `npm run-script upgrade`, which executes the following commands:
