...
export default defineConfig({
    ...
    resolve: {
        alias: [
            { find: 'rutherford-scattering/templates', replacement: path.resolve(root, 'templates') },
            { find: 'rutherford-scattering/styles',    replacement: path.resolve(root, 'styles') },
            { find: 'rutherford-scattering',           replacement: jsDir },
