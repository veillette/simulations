...
import CapacitanceControlledCapacitorView from 'views/capacitor/capacitance-controlled';
import CapacitorView from 'views/capacitor';
import WireView from 'views/wire';
import BatteryView from 'views/battery';
import CurrentIndicatorView from 'views/current-indicator';
