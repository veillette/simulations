...
import CapacitorLabSimulation from 'models/simulation';
import DielectricMaterial from 'models/dielectric-material';
import Capacitor from 'models/capacitor';
import SingleCircuit from 'models/circuit/single';
import SeriesCircuit from 'models/circuit/series';
import ParallelCircuit from 'models/circuit/parallel';
import Combination1Circuit from 'models/circuit/combination-1';
import Combination2Circuit from 'models/circuit/combination-2';
...
export default MultipleCapacitorsSimulation;
