...
import AbstractCircuit from 'models/circuit';
import Capacitor from 'models/capacitor';
import BatteryToCapacitorsTopWire from 'models/wire/battery-to-capacitors-top';
import BatteryToCapacitorsBottomWire from 'models/wire/battery-to-capacitors-bottom';
import CapacitorToCapacitorsWire from 'models/wire/capacitor-to-capacitors';
...
export default Combination1Circuit;