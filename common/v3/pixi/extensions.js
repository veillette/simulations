 ...
 * Exported as a named export; callers should import { drawPiecewiseCurve } from this module.
 */
var drawPiecewiseCurveOnCtx = function(ctx, curve, xShift, yShift, fill, stroke) {
 ...
 */
var createTexturedPolygonFromPoints = function(maskingPoints, texture) {
    /*
 ...
 */
var createColoredPolygonFromPoints = function(points, color, alpha) {
    var style = {
        fillStyle: color,
        fillAlpha: alpha
    };
...
PIXI.Sprite.fromPiecewiseCurve = function(curve, style) {
    ...
    drawPiecewiseCurveOnCtx(ctx, curve, xShift, yShift, fill, stroke);
...
export {
    drawPiecewiseCurveOnCtx as drawPiecewiseCurve,
    createTexturedPolygonFromPoints,
    createColoredPolygonFromPoints,
};
