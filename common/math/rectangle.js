/**
 * Self-contained Rectangle class.  Previously this file wrapped the
 * `rectangle-node` npm package (shimmed for AMD) and monkey-patched its
 * prototype.  That dependency has been removed; the full implementation now
 * lives here alongside the former wrapper code.
 *
 * Coordinate convention (physics / y-up):
 *   bottom() == y          (minimum y)
 *   top()    == y + h      (maximum y)
 */
