...
import defineInputUpdateLocks from '../locks/define-locks';
import WavelengthColors from '../colors/wavelength';
import 'nouislider';
import './wavelength-slider.less';
Backbone.$ = $;
...
export default WavelengthSliderView;
