...
import LadybugView from 'views/ladybug';
import LadybugTraceView from 'views/ladybug-trace';
import RemoteControlView from 'views/remote-control';
...
export default LadybugMotionSceneView;
