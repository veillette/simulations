...
import PrePopulatedDecayProportionChartView from 'radioactive-dating-game/views/decay-proportion-chart/pre-populated';
import RadiometricDatingMeterView from 'radioactive-dating-game/views/radiometric-dating-meter';
import DatingGameLandscapeView from 'radioactive-dating-game/views/landscape/dating-game';
import DatableItemView from 'radioactive-dating-game/views/datable-item';
import AnswerInputView from 'radioactive-dating-game/views/answer-input';
import AnswerLabelView from 'radioactive-dating-game/views/answer-label';
import 'radioactive-dating-game/styles/scene.less';
...
export default DatingGameSceneView;
