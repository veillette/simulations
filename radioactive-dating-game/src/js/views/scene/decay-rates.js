...
import AtomCanisterView from 'views/atom-canister';
import SphericalNucleusCollectionView from 'views/spherical-nucleus-collection';
import DecayRatesChartView from 'radioactive-dating-game/views/decay-proportion-chart/decay-rates';
...
export default DecayRatesSceneView;
