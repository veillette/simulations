...
import BarrierView from './barrier';
import SegmentPotentialView from './segment-potential';
import html from '../../templates/heatmap.html?raw';
import 'styles/heatmap.less';
Backbone.$ = $;
