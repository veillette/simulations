...
import GridView from 'common/v3/pixi/view/grid';
...
import SensorReservoir from 'views/sensor-reservoir';
import NegativeChargeReservoir from 'views/negative-charge-reservoir';
import PositiveChargeReservoir from 'views/positive-charge-reservoir';
import PositiveChargeView from 'views/positive-charge';
import NegativeChargeView from 'views/negative-charge';
import SensorView from 'views/sensor';
import VoltageMosaic from 'views/voltage-mosaic';
import VoltageTool from 'views/voltage-tool';
import EFieldVaneMatrix from 'views/efield-vane-matrix';
import ScaleLegend from 'views/scale-legend';
...
export default ChargesAndFieldsSceneView;
